...
#define STEPPER_MICROSTEPPING     3                     //Defines microstepping 0 = no microstepping, 1 = 1/2 stepping, 2 = 1/4 stepping, 4 = 1/8 stepping
...
#define STEPS_TO_CLOSE            88                    //Defines the number of steps needed to open or close fully

#define STEPPER_DIR_PIN           4                    //Marked as D2 on the NodeMCU
#define STEPPER_STEP_PIN          5                    //Marked as D1 on the NodeMCU
#define STEPPER_SLEEP_PIN         13                   //Marked as D7 on the NodeMCU
